...
class SampleQualityCallback(pl.Callback):
    ...
    # ── sampling method (can be overridden by subclasses) ───────────────────
    def _sample(self, pl_module):
        """Draw samples from the model. Subclasses can override this.
        
        Must return a numpy array in physical units with shape (batch_size, data_dim).
        """
